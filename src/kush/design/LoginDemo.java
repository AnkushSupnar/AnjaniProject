...
public class LoginDemo extends JFrame {
	...
	public LoginDemo() {
		...
		label.addMouseMotionListener(new MouseMotionAdapter() {
			...
			public void mouseDragged(MouseEvent arg0) {
				...
				LoginDemo.this.setLocation(x - xx, y - xy);
			}
		});
		...
		cmbYear.addItem("2018-2020_demo");
		cmbYear.addItem("2020_demo");

		if (prop.getProperty("MYSQLJDBC.url").equals("jdbc:mysql://localhost:3306/hotel2020_2021_demo")) {
	...
	private void load() {
		try {
			...
			if (cmbYear.getSelectedItem().equals("2018-2020_demo")) {
				prop.setProperty("MYSQLJDBC.url", "jdbc:mysql://localhost:3306/hoteldemo");
				System.out.println("2018-2020-demo Selected");
			} else if (cmbYear.getSelectedItem().equals("2020_demo"))
				prop.setProperty("MYSQLJDBC.url", "jdbc:mysql://localhost:3306/hotel2020_2021_demo");
			else
				return;
